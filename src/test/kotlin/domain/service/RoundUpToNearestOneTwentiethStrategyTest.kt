...
class RoundUpToNearestOneTwentiethStrategyTest : FreeSpec({
    ...
    "A RoundUpToNearestOneTwentiethStrategy should round up to the nearest 0.05" - {
        ...
        roundUpStrategy.round(Amount(1.89999999)).shouldBe(Amount(1.9))
        roundUpStrategy.round(Amount(1.0)).shouldBe(Amount(1.0))
        roundUpStrategy.round(Amount(1.5)).shouldBe(Amount(1.5))
        roundUpStrategy.round(Amount(2.65)).shouldBe(Amount(2.65))
        roundUpStrategy.round(Amount(17.28)).shouldBe(Amount(17.3))
